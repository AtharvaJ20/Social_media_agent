...
const PLATFORMS = {
  ...
  linkedin: {
    ...
    style: "Student thinking out loud about AI engineering or its tech stack — LLMs, RAG, LangChain, LlamaIndex, FastAPI, vector databases, MLOps, data pipelines for AI, etc. NO source claims ('I read X'), NO experience claims ('I built X'). Structure: Hook → The Concept → Why It Matters For Learners → CTA → Hashtags (always #LearningInPublic). HUMANISATION: vary sentence lengths wildly (mix 3-word sentences with longer ones), use contractions (it's, don't, I'm), start sentences with And/But/So, use casual phrases like 'Honestly,', 'Here's the thing —', 'Which makes sense, right?', add a moment of genuine surprise ('This actually surprised me.'). AVOID: delve, leverage, crucial, game-changer, seamlessly, robust, in conclusion. Write like a student typing on their phone — a little unpolished, a little excited. NOT like an AI generating a LinkedIn post. 1 emoji per section.",
    charLimit: 3000,
  },
  twitter: {
